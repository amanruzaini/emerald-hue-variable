...
export const propertyToVariableType = {
    // Color properties
    'fills': 'COLOR',
    'strokes': 'COLOR',
    'fill': 'COLOR',
 ...
 */
export function getPropertyExpectedVariableType(propertyName) {
