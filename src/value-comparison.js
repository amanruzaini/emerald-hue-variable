 ...
 */
export function figmaColorToRgb255(figmaColor) {
...
export function deltaE2000(lab1, lab2) {
    ...
    const deltaE = Math.sqrt(Math.pow(deltaL / (kL * SL), 2) +
 ...
 */
export function getNumberDifference(num1, num2) {
 ...
 */
export function calculateNumberConfidence(difference, baseValue) {
